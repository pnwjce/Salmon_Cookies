...
SalmonCookieStore.prototype.calculateCustomersPerHour = function() {
  for(var i = 0; i < 14; i++) {
...
SalmonCookieStore.prototype.renderHours = function() {
  ...
  var totalCookies = 0;
  for(var j = 0; j < this.cookiesSoldEachHour.length; i++) {
